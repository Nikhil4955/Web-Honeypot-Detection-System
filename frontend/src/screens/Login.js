  ...
  return (
    ...
    >
      <div className="w-full max-w-md p-8 bg-black/60 backdrop-blur-xl border border-white/10 rounded-sm">
        ...
        <p className="text-zinc-400 text-sm mb-8">Software Engineer AI Platform</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {error && (
            <div className="text-red-400 text-sm border border-red-500/30 bg-red-500/10 p-3 rounded-sm" data-testid="login-error-message">
              {error}
            </div>
          )}
        ...
        <p className="text-center text-zinc-400 text-sm mt-6">
          ...
          <Link to="/register" className="text-orange-500 hover:text-orange-400" data-testid="register-link">
            Register
          </Link>
        </p>
      </div>
